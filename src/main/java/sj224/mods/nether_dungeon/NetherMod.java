...
public class NetherMod
{
    ...
    public void preInit(FMLPreInitializationEvent event)
    {
        ...
        cfg.load();
        dungeonProbability=cfg.getInt("dungeon_probability","nether_dungeon",275,1,1000,"Dungeon attempts per 1000 chunks");
        lootTable=new ResourceLocation(cfg.getString("loot_table","nether_dungeon", "nether_dungeon:chests/nether_dungeon","Loot table used by nether dungeon chests"));
